...
j2,j3,j4,w,h,l2,l3,l4,m1,m2,m3,m4,h,l=sp.symbols('j2 j3 j4 w h l2 l3 l4 m1 m2 m3 m4 h l')
...
xad, xbd, xdd, ydd, xfd, yfd, xhd, yhd, phicd, phied, phigd = sp.symbols(
    r'\dot{x_a}, \dot{x_b}, \dot{x_d}, \dot{y_d}, \dot{x_f}, \dot{y_f}, \dot{x_h}, \dot{y_h}, \dot{\phi_c}, \dot{\phi_e}, \dot{\phi_h}'
)
