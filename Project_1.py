...
#vectors
q_literal_expression=sp.Matrix(12,1,[xa,xb,yb,xd,yd,xf,yf,xh,yh,phic,phie,phig])
q_dot_lietral_expression=q_literal_expression.diff(t)
...
G_literal_expression=g_literal_expression.jacobian(q_literal_expression)
...
q_dot_lietral_expression=q_dot_lietral_expression.subs(substitution)
...
' Fonction who give Matrix M(*q) g(*q) G(*q) f_ext(*q)'
' do not forget * before q is list or column'
